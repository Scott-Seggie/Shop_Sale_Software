 ...
 * @author Scott
 */
public class EditStock extends JFrame implements ActionListener 
{
...
private JLabel title = new JLabel(" Edit Sock Level ");
  ...
  if (e.getSource()==save)
{
    if (txtstock.getText().isEmpty())
        {
            JOptionPane.showMessageDialog(null, "Please enter stock level!");
        }
        else 
        {
           int selectedIndex = productList.getSelectedIndex();
